% sample_SV_OISV.m (Improved Version)
...
if flag == 0
    ...
    % We throw an error here, which is designed to be caught by the
    % try-catch block in the main MCMC script (BVAR_DPM_IOMSV_FE.m).
